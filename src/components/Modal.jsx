        ...
        <>
            ...
            <dialog id="my_modal_3" className="modal">
                <div className="modal-box">
                    ...
                    <div className="my-2 overflow-hidden overflow-y-scroll h-120">
                                ...
                                <div className="collapse-content text-sm grid grid-cols-2 gap-x-2 px-4">
                                    ...
                                    <fieldset className="fieldset">
                                        ...
                                        <input type="number" className="input w-full"
                                               onChange={(e) => setItemDetails({
                                                   ...itemDetails,
                                                   variation1: {...itemDetails.variation1, retailPrice: e.target.value}
                                               })}
                                    ...
                                    <fieldset className="fieldset">
                                        ...
                                        <input type="number" className="input w-full"
                                               onChange={(e) => setItemDetails({
                                                   ...itemDetails,
                                                   variation1: {...itemDetails.variation1, basePrice: e.target.value}
                                               })}
                                ...
                                <div className="collapse-content text-sm grid grid-cols-2 gap-x-2 px-4">
                                    ...
                                    <fieldset className="fieldset">
                                        ...
                                        <input type="number" className="input w-full"
                                               onChange={(e) => setItemDetails({
                                                   ...itemDetails,
                                                   variation2: {...itemDetails.variation2, retailPrice: e.target.value}
                                               })}
                                    ...
                                    <fieldset className="fieldset">
                                        ...
                                        <input type="number" className="input w-full"
                                               onChange={(e) => setItemDetails({
                                                   ...itemDetails,
                                                   variation2: {...itemDetails.variation2, basePrice: e.target.value}
                                               })}
                                ...
                                <div className="collapse-content text-sm grid grid-cols-2 gap-x-2 px-4">
                                    ...
                                    <fieldset className="fieldset">
                                        ...
                                        <input type="number" className="input w-full"
                                               onChange={(e) => setItemDetails({
                                                   ...itemDetails,
                                                   variation3: {...itemDetails.variation3, retailPrice: e.target.value}
                                               })}
                                    ...
                                    <fieldset className="fieldset">
                                        ...
                                        <input type="number" className="input w-full"
                                               onChange={(e) => setItemDetails({
                                                   ...itemDetails,
                                                   variation3: {...itemDetails.variation3, basePrice: e.target.value}
                                               })}
                                ...
                                <div className="collapse-content text-sm grid grid-cols-2 gap-x-2 px-4">
                                    ...
                                    <fieldset className="fieldset">
                                        ...
                                        <input type="number" className="input w-full"
                                               onChange={(e) => setItemDetails({
                                                   ...itemDetails,
                                                   variation4: {...itemDetails.variation4, retailPrice: e.target.value}
                                               })}
                                    ...
                                    <fieldset className="fieldset">
                                        ...
                                        <input type="number" className="input w-full"
                                               onChange={(e) => setItemDetails({
                                                   ...itemDetails,
                                                   variation4: {...itemDetails.variation4, basePrice: e.target.value}
                                               })}
                                ...
                                <div className="collapse-content text-sm grid grid-cols-2 gap-x-2 px-4">
                                    ...
                                    <fieldset className="fieldset">
                                        ...
                                        <input type="number" className="input w-full"
                                               onChange={(e) => setItemDetails({
                                                   ...itemDetails,
                                                   variation5: {...itemDetails.variation5, retailPrice: e.target.value}
                                               })}
                                    ...
                                    <fieldset className="fieldset">
                                        ...
                                        <input type="number" className="input w-full"
                                               onChange={(e) => setItemDetails({
                                                   ...itemDetails,
                                                   variation5: {...itemDetails.variation5, basePrice: e.target.value}
                                               })}
